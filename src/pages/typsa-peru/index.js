...
export default function TypsaPeru() {
    return (
      ...
      <div className="container-fluid mt-5">
              ...
              <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/32ad38ad9a5f948d75eeac5db88e9398.jpg'  alt="gota" />
                </Carousel.Item>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/5f6dccf4157b7d7b190ebe94bf3c99be.jpg'  alt="gota" />
                </Carousel.Item>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/ed68dca4d50b4d2795daf1f95d8171ba.jpg'  alt="gota" />
                </Carousel.Item>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/d81a0ef9faa0c934bd643b3aa8b4aa37.jpg' alt="gota" />
                </Carousel.Item>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/93d9318beeef618ea7de37fc761cb954.jpg'  alt="gota" />
                </Carousel.Item>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/9eadffdf163e1d257de0b844b67d7dc8.jpg'  alt="gota" />
                </Carousel.Item>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/d8d009226aa35a567ce72182d825b3f8.jpg'  alt="gota" />
                </Carousel.Item>
              </Carousel>
              </div>
            ...
            <div className="d-flex justify-content-center">
              ...
              <Carousel className="container-md" style={{ maxWidth: "443px", height: "428px" }}>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/dcfc7be5b2e5e1b4c332c146abf13ccd.jpg' alt="gota" />
                </Carousel.Item>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/e7a9bb4508315c7c5572704fc35fe2e0.jpg'  alt="gota" />
                </Carousel.Item>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/c9b9e0e28495dd5dee24c0dfb61c0c03.jpg'  alt="gota" />
                </Carousel.Item>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/100cdfd6cdb199df0a7389174aa68d8b.jpg'  alt="gota" />
                </Carousel.Item>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/a29752300fb23f9b4b7534089e4bff70.jpg'  alt="gota" />
                </Carousel.Item>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/42a237dc8c6d6d121d6c707d87ef5b98.jpg'  alt="gota" />
                </Carousel.Item>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/c3c7cea6a9edeab239e09333eec32340.jpg' width={463} height={428} alt="gota" />
                </Carousel.Item>
          ...
          <section>
              ...
              <Carousel className="container-md img-fluid" style={{ maxWidth: "443px", height: "428px" }}>
                ...
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/e6663689600f3bb8c8665695c321a132.jpg'  alt="gota" />
                </Carousel.Item>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/2dd80095784bfb7c713948c53bfa86e4.jpg'  alt="gota" />
                </Carousel.Item>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/4e89e293f0720b6f1707c7e894c1ee94.jpg'  alt="gota" />
                </Carousel.Item>
            ...
            <div className="d-flex justify-content-center">
              ...
              <Carousel className="container-md img-fluid" style={{ maxWidth: "443px", height: "428px" }}>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/8a333d0d7055393e3cae3641aa8dce5a.jpg'  alt="gota" />
                </Carousel.Item>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/0fd845a6b23c380d40678a7acad60ce6.jpg'  alt="gota" />
                </Carousel.Item>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/e5a0d07cd4da0e7d4659f07d3bef0b29.jpg'  alt="gota" />
                </Carousel.Item>
            ...
            <div className="d-flex justify-content-center ">
              ...
              <Carousel className="container-md mt-3 img-fluid" style={{ maxWidth: "200px", height: "200px" }}>
                ...
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/bbf778dbc37f6e965b397ffca982e9da.jpg'  alt="gota" />
                </Carousel.Item>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/fb1cd05a121c7d3e465f7ed68a2805ef.jpg'  alt="gota" />
                </Carousel.Item>
              </Carousel>
              </div>
              <div className="text-start ms-5 " style={{maxWidth: '661px'}}>
            ...
            <div className="d-flex justify-content-center">
              ...
              <Carousel className="container-md img-fluid" style={{ maxWidth: "443px", height: "428px" }}>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/53d3ecc1c4ab361026906006afa3cb92.jpg'  alt="gota" />
                </Carousel.Item>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/055ea8b548e0ac8f6d959fab44b477ab.jpg'  alt="gota" />
                </Carousel.Item>
              </Carousel>
              </div>
              <div className="text-start ms-5 " style={{maxWidth: '661px'}}>
            ...
            <div className="d-flex justify-content-center ">
              ...
              <Carousel className="container-md  img-fluid" style={{ maxWidth: "443px", height: "428px" }}>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/4c5b55a76f8dfcc2b51825f55ba2a527.jpg'  alt="gota" />
                </Carousel.Item>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/f4539407bccc1db3fdd89f219126b567.jpg'  alt="gota" />
                </Carousel.Item>
              </Carousel>
              </div>
              <div className="text-start ms-5 " style={{maxWidth: '661px'}}>
            ...
            <div className="d-flex justify-content-center ">
              ...
              <Carousel className="container-md img-fluid" style={{ maxWidth: "443px", height: "428px" }}>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/222a2d0839234fedc6d9bb96df8b80bd.jpg'  alt="gota" />
                </Carousel.Item>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/0aae4d5b0a7eb7e1aa2f5938d7abbbe9.jpg'  alt="gota" />
                </Carousel.Item>
              </Carousel>
              </div>
              <div className="text-start ms-5 " style={{maxWidth: '661px'}}>
            ...
            <div className="d-flex justify-content-center">
              ...
              <Carousel className="container-md img-fluid" style={{ maxWidth: "443px", height: "428px" }}>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/8208e533c6182b0db39ee56106f358d9.jpg'  alt="gota" />
                </Carousel.Item>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/0a88dfea78b83a87de1c5d4008c35ecb.jpg'  alt="gota" />
                </Carousel.Item>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/14f879d58b51c0088a1f6244e8ec10bd.jpg'  alt="gota" />
                </Carousel.Item>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/596b849be6a53198bab15b1ecbb4e6ab.jpg'  alt="gota" />
                </Carousel.Item>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/e837aafdd69dd154aca68dc066484e50.jpg'  alt="gota" />
                </Carousel.Item>
                <Carousel.Item>
                <img  className="d-block w-100 img-fluid" src='/imagen/TYPSA-PERU/e959649621ee4af663c60b5402ad3809.jpg'  alt="gota" />
                </Carousel.Item>
              </Carousel>
              </div>
