    ...
    return (
      ...
      <section>
        ...
        <div> 
          <Carousel className="container-md mt-5">
            <Carousel.Item>
            <img  className="d-block w-100 Image-fluid" src='/imagen/TYPSA-PERU/85e122df42a72f8d103fe331fc0d6ed9.jpg' width={1168} height={660} alt="gota" />
            </Carousel.Item>
            <Carousel.Item>
            <img  className="d-block w-100 Image-fluid" src='/imagen/TYPSA-PERU/9389107eb1267552df5d6693281b1c55.jpg' width={1168} height={660} alt="gota" />
            </Carousel.Item>
            <Carousel.Item>
            ...
            <Carousel.Item>
            <img  className="d-block w-100 Image-fluid" src='/imagen/TYPSA-PERU/010276a4cc80d932bba0757a4159a69a.jpg' width={1168} height={660} alt="gota" />
            </Carousel.Item>
          </Carousel>
        ...
        <div> 
          <Carousel className="container-md mt-5">
            <Carousel.Item>
            <img  className="d-block w-100 Image-fluid" src='/imagen/TYPSA-PERU/23229acbc140e9b43b6ee75e7bb0aeb4.jpg' width={1168} height={660} alt="gota" />
            </Carousel.Item>
            <Carousel.Item>
            <img  className="d-block w-100 Image-fluid" src='/imagen/TYPSA-PERU/89a288116456105063570f5a2bc0ec7a.jpg' width={1168} height={660} alt="gota" />
            </Carousel.Item>
            <Carousel.Item>
            <img  className="d-block w-100 Image-fluid" src='/imagen/TYPSA-PERU/3a934edfc349645a30c7d2372fd6b20b.jpg' width={1168} height={660} alt="gota" />
            </Carousel.Item>
            <Carousel.Item>
            <img  className="d-block w-100 Image-fluid" src='/imagen/TYPSA-PERU/f164540bf9ffe70dc60e4b88ffa02cf4.jpg' width={1168} height={660} alt="gota" />
            </Carousel.Item>
            <Carousel.Item>
            <img  className="d-block w-100 Image-fluid" src='/imagen/TYPSA-PERU/cdec8b4cd884994acbd828d48eb8ab4a.jpg' width={1168} height={660} alt="gota" />
            </Carousel.Item>
            <Carousel.Item>
            <img  className="d-block w-100 Image-fluid" src='/imagen/TYPSA-PERU/1e1f55e0be49c86229ca68eac118a104.jpg' width={1168} height={660} alt="gota" />
            </Carousel.Item>
            <Carousel.Item>
            <img  className="d-block w-100 Image-fluid" src='/imagen/TYPSA-PERU/aac003fcc019ab59142e179fb674efcf.jpg' width={1168} height={660} alt="gota" />
            </Carousel.Item>
            <Carousel.Item>
            <img  className="d-block w-100 Image-fluid" src='/imagen/TYPSA-PERU/3d6ff6ac5ce436d40ab17218d3c80cf4.jpg' width={1168} height={660} alt="gota" />
            </Carousel.Item>
            <Carousel.Item>
            <img  className="d-block w-100 Image-fluid" src='/imagen/TYPSA-PERU/d5272eec3d561e1c44da8654904b0417.jpg' width={1168} height={660} alt="gota" />
            </Carousel.Item>
            <Carousel.Item>
            <img  className="d-block w-100 Image-fluid" src='/imagen/TYPSA-PERU/712d8b4dbcdc93fc89db2458295dec4b.jpg' width={1168} height={660} alt="gota" />
            </Carousel.Item>
            <Carousel.Item>
            <img  className="d-block w-100 Image-fluid" src='/imagen/TYPSA-PERU/a252e9d932c2fe95fcbf8dff637486b6.jpg' width={1168} height={660} alt="gota" />
            </Carousel.Item>
            <Carousel.Item>
            <img  className="d-block w-100 Image-fluid" src='/imagen/TYPSA-PERU/f94f62916ee54dafe5980099a27a43c0.jpg' width={1168} height={660} alt="gota" />
            </Carousel.Item>
      ...
      <div className="container-fluid mt-5">
                <div className="row text-danger fs-4 fw-bolder">
                  ...
                  <div className="col-md-6 d-flex flex-column align-items-center mb-4">
                    <div className="col-sm-6 col-lg-3 my-2" style={{width: '562px', height: '376px'}}>
                      <img className="Image-fluid" src='/imagen/TYPSA-PERU/89a288116456105063570f5a2bc0ec7a.jpg' width={562} height={376} alt="gota"/>  
                    </div>
